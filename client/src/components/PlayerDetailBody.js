...
import PlayerRolling from '../components/PlayerRolling'
        ...
        : (
            <div id='player-detail-body'>
                ...
                <section className='cards-3'>
                            ...
                            <table className='player-pitch-types-table'>
                                <tbody>
                                    <tr>
                                        ...
                                        <Tooltip TransitionComponent={({ children }) => children}title={<span style={{ fontSize: '1rem' }}>Number of Each Pitch Type Seen</span>} placement='top'>
                                            <td><strong>#</strong></td>
                                        </Tooltip>
                                        <Tooltip TransitionComponent={({ children }) => children}title={<span style={{ fontSize: '1rem' }}>Expected Batting Average</span>} placement='top'>
                                            <td><strong>xAVG</strong></td>
                                        </Tooltip>
                                        <Tooltip TransitionComponent={({ children }) => children}title={<span style={{ fontSize: '1rem' }}>Expected Slugging Percentage</span>} placement='top'>
                    ...
                    <div className='card-3'>
                        <div className='player-splits-heading-container'>
                            <Tooltip TransitionComponent={({ children }) => children}
                                title={<span style={{ fontSize: '1rem' }}>
                                    Rolling batting average of past 50 PA<br />
                                    Line going up = Batter is on a hot streak<br />
                                    Line going down = Batter is in a slump<br />
                                    Line is flat = Steady performance<br /></span>} placement='top'>
                                <div>2020 Batting Average Tracker</div>
                            </Tooltip>
                        </div>
                        <div className='graph-holder-rolling'>
