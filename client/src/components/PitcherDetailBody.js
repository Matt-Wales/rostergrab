...
import PitcherMovement from '../components/PitcherMovement'
                    ...
                    <div className='card-2'>
                        ...
                        <div className='player-splits-table-container'>
                            <table className='player-splits-table'>
                                <tbody>
                                    <tr>
                                        <Tooltip TransitionComponent={({ children }) => children}className='player-splits-table-metric' title={<span style={{ fontSize: '1rem' }}>Batting Average Against</span>} placement='top'>
                                            <td>AVG</td>
                                        </Tooltip>
                                        <td className='player-splits-table-value'>{vsALL.avg}</td>
                                    </tr>
                                    <tr>
                                        <Tooltip TransitionComponent={({ children }) => children}className='player-splits-table-metric' title={<span style={{ fontSize: '1rem' }}>Strikeouts Per 9 Innings Pitched</span>} placement='top'>
                                            <td>K/9</td>
                                        </Tooltip>
                                        <td className='player-splits-table-value'>{vsALL.strikeoutsPer9Inn}</td>
                                    </tr>
                                    <tr>
                                        <Tooltip TransitionComponent={({ children }) => children}className='player-splits-table-metric' title={<span style={{ fontSize: '1rem' }}>Walks Per 9 Innings Pitched</span>} placement='top'>
                                            <td>BB/9</td>
                                        </Tooltip>
                                        <td className='player-splits-table-value'>{vsALL.walksPer9Inn}</td>
                                    </tr>
                                    <tr>
                                        <Tooltip TransitionComponent={({ children }) => children}className='player-splits-table-metric' title={<span style={{ fontSize: '1rem' }}>Hits Per 9 Innings Pitched</span>} placement='top'>
                                            <td>H/9</td>
                                        </Tooltip>
                                        <td className='player-splits-table-value'>{vsALL.hitsPer9Inn}</td>
                                    </tr>
                                    <tr>
                                        <Tooltip TransitionComponent={({ children }) => children}className='player-splits-table-metric' title={<span style={{ fontSize: '1rem' }}>Home Runs Per 9 Innings Pitched</span>} placement='top'>
                                            <td>HR/9</td>
                                        </Tooltip>
                            ...
                            <table className='player-pitch-types-table'>
                                <tbody>
                                    <tr>
                                        ...
                                        <Tooltip TransitionComponent={({ children }) => children}title={<span style={{ fontSize: '1rem' }}>Average Velocity in MPH</span>} placement='top'>
                                            <td><strong>Velocity</strong></td>
                                        </Tooltip>
                                        <Tooltip TransitionComponent={({ children }) => children}title={<span style={{ fontSize: '1rem' }}>Average Spin Rate in RPM</span>} placement='top'>
                                            <td><strong>Spin Rate</strong></td>
                                        </Tooltip>
                                        <Tooltip TransitionComponent={({ children }) => children}title={<span style={{ fontSize: '1rem' }}>(Whiffs / Pitches) * 100</span>} placement='top'>
                                            <td><strong>Whiff %</strong></td>
                                        </Tooltip>
                                        <Tooltip TransitionComponent={({ children }) => children}title={<span style={{ fontSize: '1rem' }}>Expected Weighted On-Base Average Against</span>} placement='top'>
