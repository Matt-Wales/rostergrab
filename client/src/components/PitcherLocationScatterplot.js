...
const PitcherLocationScatterplot = ({ pitchTypes }) => {
    ...
    useEffect(() => {
        ...
        g.append('rect')
            ...
            .attr('y', d => (!d) ? 0 : (tooltip.plate_z <= 1.3) ? yScale(-tooltip.plate_z) - 63 : yScale(-tooltip.plate_z) + 33)
        ...
        g.append('text')
            ...
            .attr('y', d => (!d) ? 0 : (tooltip.plate_z <= 1.3) ? yScale(-tooltip.plate_z) - 43 : yScale(-tooltip.plate_z) + 52)
            .attr('fill', '#fff')
