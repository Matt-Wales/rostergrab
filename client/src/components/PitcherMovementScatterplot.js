...
const PitcherMovementScatterplot = ({ pitchTypes }) => {
    ...
    useEffect(() => {
        ...
        g.append('rect')
            ...
            .attr('y', d => (!d) ? 0 : (-tooltip.pfx_z >= 0.9) ? yScale(-tooltip.pfx_z) - 103 : yScale(-tooltip.pfx_z) + 33)
        ...
        g.append('text')
            ...
            .attr('y', d => (!d) ? 0 : (-tooltip.pfx_z >= 0.9) ? yScale(-tooltip.pfx_z) - 85 : yScale(-tooltip.pfx_z) + 52)
            .attr('fill', '#fff')
        ...
        g.append('text')
            ...
            .join('text')
            .attr('x', d => (!d) ? 0 : (tooltip.pfx_x <= 0) ? xScale(-tooltip.pfx_x) - 84 : xScale(-tooltip.pfx_x) + 86)
            .attr('y', d => (!d) ? 0 : (-tooltip.pfx_z >= 0.9) ? yScale(-tooltip.pfx_z) - 65 : yScale(-tooltip.pfx_z) + 72)
            .attr('fill', '#fff')
            .attr('text-anchor', 'middle')
            .attr('font-size', '0.9rem')
        ...
        g.append('text')
            ...
            .join('text')
            .attr('x', d => (!d) ? 0 : (tooltip.pfx_x <= 0) ? xScale(-tooltip.pfx_x) - 84 : xScale(-tooltip.pfx_x) + 86)
            .attr('y', d => (!d) ? 0 : (-tooltip.pfx_z >= 0.9) ? yScale(-tooltip.pfx_z) - 45 : yScale(-tooltip.pfx_z) + 92)
            .attr('fill', '#fff')
            .attr('text-anchor', 'middle')
            .attr('font-size', '0.9rem')
