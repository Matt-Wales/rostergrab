...
import PlayerGrid from '../content/PlayerGrid'
...
const RosterPage = ({ match }) => {
    ...
    useEffect(() => {
        const fetchPlayers = async () => {
            const result = await axios.get(`https://statsapi.mlb.com/api/v1/teams/${id}/roster?hydrate=person&language=en&season=2020&rosterType=Active`)
